...
def infortuni():
    ...
    if request.method == "POST":
        ...
        return render_template('infortuni.html',  title=title)
...
def ictus():
    ...
    if request.method == "POST":
        ...
        return render_template('ictus.html',  title=title)
...
def sclerosimultipla():
    ...
    if request.method == "POST":
        ...
        return render_template('sclerosimultipla.html',  title=title)
